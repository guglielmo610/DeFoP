...
void AttitudeController::InitializeParams() {
  ...
  // gain_attitude_(2) = 4.5;

  // gain_angular_rate_(0) = 0.15;//0.6;
  // gain_angular_rate_(1) = 0.15;//0.6;
  // gain_angular_rate_(2) = 0.25;
  ...
  const double rotor_force_constant = 0.0000068; //0.00000169153; //0.00000854858;  //F_i = k_n * rotor_velocity_i^2
  const double rotor_moment_constant = 0.016; //0.016;  // M_i = k_m * F_i

  angular_acc_to_rotor_velocities_.resize(amount_rotors_, 4);
  const double arm_length = 0.13; //0.13; //0.215;
