...
gflags.DEFINE_string('train_tf_folder', './tfrecords_data/train', 'folder containing training data')
gflags.DEFINE_string('validate_tf_folder', './tfrecords_data/validate', 'folder containing validate data')
