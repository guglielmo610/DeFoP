...
class Encoder(nn.Module):
    ...
    def define_encoder(self):
        ...
        self.conv0 = nn.Conv2d(self.input_dim, 32, kernel_size=6, stride=2, padding=2)
        self.conv0_1 = nn.Conv2d(32, 32, kernel_size=4, stride=2, padding=2)
        ...
        self.conv1_1 = nn.Conv2d(32, 64, kernel_size=5, stride=1, padding=2)
    ...
    def encode(self, img):
        ...
        #print('x1_1:'+str(x1_1.shape)+' ; x0_jump_2:'+str(x0_jump_2.shape))
