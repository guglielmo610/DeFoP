...
class DownsampleModule(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # Two convolutional layers with 3x3 kernels and padding for gradual downsampling
        self.deconv1 = nn.ConvTranspose2d(in_channels, out_channels, kernel_size=5, stride=2, padding=(91,161) )
        self.relu1 = nn.LeakyReLU(0.2)  # Leaky ReLU activation
        # Max pooling with stride 2 for significant downsampling
...
class Encoder(nn.Module):
    ...
    def __init__(self, input_dim, latent_dim):
        ...
        self.define_encoder()
        self.elu = nn.ELU()
        #self.downsample = DownsampleModule(self.input_dim, 16)
    ...
    def define_encoder(self):
        ...
        #self.conv0 = nn.Conv2d(16, 32, kernel_size=5, stride=2, padding=2)
        ...
        #self.dense0 = nn.Linear(8*6*128, 512)
...
if __name__== '__main__':
    ...
    #summary(encoder, (1, 480, 640), device="cuda") 
