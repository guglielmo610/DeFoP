...
class ImgDecoder(nn.Module):
    ...
    def __init__(self, input_dim=1, latent_dim=64, with_logits=False):
        ...
        #self.deconv7 = nn.ConvTranspose2d(16, 8, kernel_size=4, stride=2, padding=2)
        #self.deconv8 = nn.ConvTranspose2d(8, self.n_channels, kernel_size=4, stride=2, padding=(91,161))
