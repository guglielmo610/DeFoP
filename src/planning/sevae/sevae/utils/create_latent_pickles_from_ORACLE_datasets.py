...
def read_pickle_files(depth_pickle_file, append_filename):
    ...
    depth_latent_filename = depth_pickle_file.replace("di_dump", "di_latent")
    depth_flipped_latent_filename = depth_pickle_file.replace("di_dump", "di_flipped_latent")
...
if __name__ == "__main__":
    ...
    #LOAD_MODEL_FILE = "/home/dgguglielmo/norv_vae_ws/src/planning/sevae/sevae/weights/seVAE_weights/seVAE_evo_LD_128.pth"
    LOAD_MODEL_FILE = "/home/dgguglielmo/norv_vae_ws/src/planning/sevae/sevae/weights/seVAE_weights/6_LD_128_epoch_39.pth"
    

    # read folder name from first argument 
    folder_name = "/home/dgguglielmo/norv_vae_ws/src/planning/ORACLE/depth_images_test" #sys.argv[1]
